          ...
          >
            ...
            >
              ...
              <div className="mob-socials" style={{ 
                ...
                <a href="https://t.me/konservatoriya_uz" target="_blank" rel="noopener noreferrer" className="mob-social-btn" aria-label="Telegram">
                ...
                <a href="https://instagram.com/konservatoriya_uz" target="_blank" rel="noopener noreferrer" className="mob-social-btn" aria-label="Instagram">
                ...
                <a href="https://youtube.com/@konservatoriya_uz" target="_blank" rel="noopener noreferrer" className="mob-social-btn" aria-label="YouTube">
                   <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
