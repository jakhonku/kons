      ...
      sections={[
        {
          ...
          cards: [
            { tag: "01", title: "Oʻquv-metodik boʻlim", desc: "Oʻquv rejalari, sillabuslar va metodik taʼminotni boshqaradi.", meta: "Boshliq: Karimov Bobur Sherzodovich" },
            { tag: "02", title: "Bakalavriat boʻlimi", desc: "Bakalavr taʼlimining barcha jarayonlarini muvofiqlashtiradi.", meta: "Boshliq: Yusupova Madina Otabekovna" },
        ...
        {
          heading: "Maʼmuriy va xizmat boʻlimlari",
          cards: [
            ...
            { tag: "12", title: "Talabalar bilan ishlash boʻlimi", desc: "Maʼnaviyat, marifat va talabalar faoliyati.", meta: "Boshliq: Toshmatov Akbar Sherzodovich" },
          ],
        },
      ]}
      contact={{
        title: "Maʼmuriyat qabulxonasi",
