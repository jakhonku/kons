...
export default function EurasianMusicJournal() {
  return (
    <InfoPage
      ...
      lead="Eurasian Music Journal (EMJ) — Markaziy Osiyo va Yevroosiyo musiqa madaniyati, tarixi, nazariyasi va ijro san'atiga bag'ishlangan ingliz tilidagi xalqaro ilmiy jurnal. 2021-yildan beri konservatoriya tomonidan nashr qilinadi."
      stats={[
