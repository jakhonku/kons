...
export default function IlmFan() {
  return (
    <InfoPage
      ...
      lead="Konservatoriyaning ilmiy faoliyati musiqashunoslik, etnomusiqashunoslik, ijrochilik nazariyasi, kompozitsiya texnikalari va musiqa pedagogikasi yoʻnalishlarini qamrab oladi. Yiliga 50+ ilmiy maqola, 8+ konferensiya va 3+ monografiya nashr qilinadi."
      stats={[
      ...
      sections={[
        {
          heading: 'Ilmiy faoliyat yoʻnalishlari',
          cards: [
        ...
        },
        {
          ...
          cards: [
            ...
            { tag: 'Xalqaro', title: 'Eurasian Music Journal', desc: "Markaziy Osiyo va Yevroosiyo musiqa madaniyatiga bagʻishlangan ingliz tilidagi jurnal.", meta: '/eurasian-music-journal' },
        ...
        },
        {
          ...
          items: [
            ...
            "Italiya, Germaniya, Janubiy Koreya bilan qoʻshma loyihalar",
