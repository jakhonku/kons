...
const DOCUMENTS = [
  {
    ...
    title: {
      ...
      ru: 'Инструментальное исполнительство: Народные инструменты (Чанг)',
      en: 'Instrumental Performance: Folk Instruments (Chang)',
    },
    meta: {
      uz: 'PDF hujjat · Chang',
      ru: 'PDF документ · Чанг',
      en: 'PDF document · Chang',
    },
  },
  {
    ...
    title: {
      ...
      ru: 'Инструментальное исполнительство: Народные инструменты (Най, Кошнай, Баян, Аккордеон)',
      en: 'Instrumental Performance: Folk Instruments (Nay, Koshnay, Bayan, Accordion)',
    },
    meta: {
      uz: 'PDF hujjat · Nay, Qoʻshnay, Bayan, Akkordeon',
      ru: 'PDF документ · Най, Кошнай, Баян, Аккордеон',
      en: 'PDF document · Nay, Koshnay, Bayan, Accordion',
    },
  },
  {
    ...
    title: {
      ...
      ru: 'Инструментальное исполнительство: Струнные инструменты (Скрипка, Альт) (Узбекский)',
      en: 'Instrumental Performance: String Instruments (Violin, Viola) (Uzbek)',
    },
    meta: {
      uz: 'PDF hujjat · Skripka, Alt',
      ru: 'PDF документ · Скрипка, Альт',
      en: 'PDF document · Violin, Viola',
    },
  },
];
